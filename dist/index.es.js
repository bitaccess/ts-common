import { Type, success, number, string, failure, identity, type, Function, partial, union, nullType, undefined as undefined$1, intersection, keyof, getFunctionName, UnionType, IntersectionType } from 'io-ts';
...
function partialRecord(k, type, name) {
    return partial(Record_19(k.keys, () => type), name);
}
